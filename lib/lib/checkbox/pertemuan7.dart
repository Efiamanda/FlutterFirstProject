...
class RadiobuttonPage extends StatefulWidget {
  ...
  @override
  _CompleterRadioButtonFormState createState() =>
      _CompleterRadioButtonFormState();
}

class _CompleterRadioButtonFormState extends State<RadiobuttonPage>
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: FormField<String>(
                        validator: (value) => _selectedGender == true
                ...
                _buildModernSection('Pekerjaan', Icons.work_outline, [
                  Card(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(20),
                      child: FormField<String>(
                        validator: (value) => _selectedJob == null
                ...
                // Tipe Pekerjaan (Custom Radio List Tile)
                _buildModernSection(
                  'Tipe Pekerjaan',
                  Icons.business_center_outlined,
                  [
                    FormField<String>(
                      validator: (value) => _selectedWorkType == null
